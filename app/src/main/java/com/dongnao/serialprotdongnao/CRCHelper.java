...
public final class CRCHelper {
    ...
    public static byte calCRC8(byte[] data) {
        return calCRC8(data, 0, data.length, (byte) 0);
    }

    public static byte calCRC8(byte[] data, int offset, int len) {
        return calCRC8(data, offset, len, (byte) 0);
    }

    public static byte calCRC8(byte[] data, int offset, int len, byte preval) {
        byte ret = preval;
